...
std::shared_ptr[tf2_ros::Buffer](tf2_ros::Buffer) _tf_buffer_;
std::shared_ptr[tf2_ros::TransformListener](tf2_ros::TransformListener) _tf_listener_;

_tf_buffer_ = std::make_shared[tf2_ros::Buffer](tf2_ros::Buffer)(_node_->get_clock());
_tf_listener_ = std::make_shared[tf2_ros::TransformListener](tf2_ros::TransformListener)(*_tf_buffer_);
